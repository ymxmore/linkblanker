...
var Preference = React.createClass({
  ...
  componentDidMount: function () {
    PreferenceStore.addChangeListener(this.setStateAndProps);
    this.setStateAndProps();
  },

  componentWillUnmount: function () {
    PreferenceStore.removeChangeListener(this.setStateAndProps);
  },
  ...
  render: function () {
    return (
      <div id="wrapper">
        ...
        <section>
          <h4 className="preference-header">
        ...
        <footer>
          <h4 className="preference-header">Links</h4>
